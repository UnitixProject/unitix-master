...
!define URL http://www.unitix.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/unitix.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\unitix-qt.exe
...
OutFile unitix-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/unitix-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/unitixd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\unitix.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\unitix-qt.exe
