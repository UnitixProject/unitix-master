...
// unitix: total coins staked (non-spendable until maturity)
...
// unitix: check 'spent' consistency between wallet and txindex
// unitix: fix wallet spent state according to txindex
...
// unitix: disable transaction (only for coinstake)
